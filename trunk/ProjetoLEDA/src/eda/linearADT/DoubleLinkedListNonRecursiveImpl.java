...
/**
 * The node of a non recursive linked list. This class is recursive. Fill the
 * class.
 */
...
/**
 * Estrutura representa uma lista dupla implementada de forma nao recursiva. Os
 * metodos podem ser recursivos (recomendado) e nao precisam ser definidos na
 * classe DoubleListNode. A estrutura guarda apenas o no inicial (head) da lista
 * e tambem o ultimo no da lista, para possibilitar acesso pelo final da lista.
 * A estrutura deve ter um tamanho inicial, um tamanho maximo que pode crescer e
...
public class DoubleLinkedListNonRecursiveImpl<E> implements DoubleLinkedList<E> {
	...
	public DoubleLinkedListNonRecursiveImpl(){
		this.size = 0;
	}
	
	public DoubleLinkedListNonRecursiveImpl(DoubleLinkedListNode head, DoubleLinkedListNode tail){
		this.head = head;
		this.tail = tail;
	}
...
//					}
	...
	public DoubleLinkedList<E> addFirst(int numero) throws ADTOverflowException {
		...
		return new DoubleLinkedListNonRecursiveImpl(head, tail);
	}
